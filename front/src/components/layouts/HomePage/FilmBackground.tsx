...
const FilmBackground: React.FC<FilmBackgroundProps> = ({ children }) => {
  return (
    <div className={`relative flex flex-row contrast-75 min-h-screen w-full z-10 m-0 p-0 ${styles["bg-half-repeat"]} lg:${styles["bg-lg-half-repeat"]}`}>
      ...
      <div className="flex flex-col items-center h-full w-full border-black border-8 shadow-2xl">
